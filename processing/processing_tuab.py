...
if __name__ == "__main__":
    ...
    root = "./data/raw/TUAB/v3.0.1/edf"
    out = "./data/processed/tuab"
    ...
    if not os.path.exists(os.path.join(out, "process_refine")):
        os.makedirs(os.path.join(out, "process_refine"))

    if not os.path.exists(os.path.join(out, "process_refine", "train")):
        os.makedirs(os.path.join(out, "process_refine", "train"))
    train_dump_folder = os.path.join(out, "process_refine", "train")

    if not os.path.exists(os.path.join(out, "process_refine", "val")):
        os.makedirs(os.path.join(out, "process_refine", "val"))
    val_dump_folder = os.path.join(out, "process_refine", "val")

    if not os.path.exists(os.path.join(out, "process_refine", "test")):
        os.makedirs(os.path.join(out, "process_refine", "test"))
    test_dump_folder = os.path.join(out, "process_refine", "test")
